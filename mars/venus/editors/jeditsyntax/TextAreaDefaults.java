 ...
 */
    ...
    */
       public static TextAreaDefaults getDefaults()
      {
         ...
         DEFAULTS.caretColor = BetterColors.TXT_CARET_COLOR;//Color.black; // Color.red;
         DEFAULTS.selectionColor = BetterColors.TXT_MULTIPLE_SEL_BG_COLOR;//new Color(0xccccff);
         DEFAULTS.lineHighlightColor = BetterColors.TXT_SINGULAR_SEL_BG_COLOR;//new Color(0xeeeeee);//0xe0e0e0);
